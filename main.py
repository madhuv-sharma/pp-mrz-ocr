...
pytesseract.pytesseract.tesseract_cmd = "/Tesseract-OCR/tesseract.exe" # Location of 'tesseract.exe' file
tessdata_dir_config = '--tessdata-dir "/Tesseract-OCR/tessdata"' # Location of 'tessdata' folder
file_loc = r" " # Input Image Location
